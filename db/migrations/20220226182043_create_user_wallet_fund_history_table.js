...
exports.up = function(knex) {
    return knex.schema.createTable('user_wallet_fund_history', function (table) {
      table.increments('id');
      ...
      table.integer('amount_funded', 11).defaultTo(0);
...
exports.down = function(knex) {
  return knex.schema.dropTable('user_wallet_fund_history');
};
